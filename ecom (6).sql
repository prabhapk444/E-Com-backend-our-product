...
(2, 'Sales', '2026-05-06 05:53:06', '2026-05-06 05:53:06'),
(4, 'Support', '2026-05-06 05:53:06', '2026-05-06 05:53:06'),
(7, 'Security', '2026-05-06 05:53:06', '2026-05-06 05:53:06');
...
(1, 'Date Entry', '2026-04-30 12:02:40', '2026-04-30 12:02:40'),
(2, 'Store Manager', '2026-05-06 04:42:45', '2026-05-06 04:42:45'),
(3, 'Delivery Driver', '2026-05-06 04:43:05', '2026-05-06 04:43:05'),
(4, 'Cashier', '2026-05-06 04:43:17', '2026-05-06 04:43:17'),
(5, 'online Sales Associate', '2026-05-06 09:57:56', '2026-05-06 09:57:56');
...
CREATE TABLE `products` (
  ...
  `product_type` enum('simple','variable','shoes','textiles','gifts','digital','service') NOT NULL DEFAULT 'simple',
  `variant_option_schema` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`variant_option_schema`)),
  `quantity` int(11) NOT NULL,
  `price` decimal(10,2) NOT NULL,
