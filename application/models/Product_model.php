...
class Product_model extends CI_Model {
    ...
    public function get_all($limit = 10, $offset = 0, $search = '', $category_id = null, $is_active = null, $product_type = null, $featured = null, $new_arrivals = null, $best_seller = null) {
        ...
        if ($best_seller !== null && $best_seller !== '') {
            $this->db->where('p.best_seller', $best_seller);
        }
