...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2026 at 08:40 AM
...
(1, 'test', 1, 5, NULL, '2026-03-24 05:21:11', NULL);
...
INSERT INTO `products` (`id`, `name`, `slug`, `description`, `short_description`, `category_id`, `subcategory_id`, `image`, `images`, `featured`, `rating`, `review_count`, `gst`, `weight`, `hsn_code`, `note`, `discount`, `is_active`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'test', 'test', 'test', '', 1, 1, 'watch 1.webp', '[]', 0, 0.00, 0, '5', '300g', '5205', 'not', '50', '1', NULL, NULL, '2026-03-24 08:33:52', '2026-03-24 08:39:26');
...
INSERT INTO `product_variants` (`id`, `product_id`, `sku`, `size`, `color`, `price`, `compare_at_price`, `discount`, `stock`, `image`, `is_active`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(2, 1, NULL, NULL, NULL, 0.00, NULL, 0.00, 0, NULL, '1', NULL, NULL, '2026-03-24 08:39:26', '2026-03-24 08:39:26');
...
(1, 'test sub', 1, 1, 5, NULL, '2026-03-24 06:22:58', NULL);
